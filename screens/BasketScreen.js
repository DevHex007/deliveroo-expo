...
import { selectRestaurant } from '../features/restSlice';
  ...
  return (
    <SafeAreaView className='flex-1 bg-white'>
      <View className='flex-1 bg-gray-100'>
        ...
        >
          <XCircleIcon color='#8bcfb9' height={50} width={50} />
        </TouchableOpacity>
      </View>

      <View className='flex-row items-center space-x-4 px-4 py-3 bg-white my-5'>
        <Image source={images.avatar_3}
         className='h-7 w-7 bg-gray-300 p-4 rounded-full'
        />
        <Text className='flex-1'>Delivery is 50-75 min</Text>
        <TouchableOpacity>
      ...
      <View className='p-5 bg-white mt-5 space-y-4 '>
        ...
        <View className='flex-row justify-between'>
          ...
          <Text className='text-gray-600'>
            <Currency quantity={400} currency='NGN' />
          </Text>
        </View>
        ...
        <View className='flex-row justify-between'>
          ...
          <Text className='font-extrabold'>
            <Currency quantity={basketTotal + 400} currency='NGN' />
          </Text>
        </View>
        
        <TouchableOpacity className='rounded-lg bg-[#00CC88] p-4'
          onPress={() => navigation.navigate('PreparingOrderScreen',{screen: 'PreparingOrderScreen'})}
        >
